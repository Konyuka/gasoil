        ...
        <div class="relative bg-white shadow-xl">
          ...
          <div class="grid grid-cols-1 lg:grid-cols-3">
            ...
            <div class="relative overflow-hidden py-10 px-6 bg-gradient-to-b from-blue-400 to-yellow-600 sm:px-10 xl:p-12">
              ...
              <h3 class="text-xl font-medium text-gray-600 ">Contact information</h3>
              <p class="mt-6 text-base text-gray-600 max-w-3xl italic">We normally reply within 24 Hours</p>
              ...
              <ul role="list" class="mt-8 flex space-x-12">
                <li>
                  <a class="text-teal-200 hover:text-black" href="#">
    ...
    <section aria-labelledby="offices-heading">
      <div class="max-w-7xl mx-auto py-24 px-4 sm:py-12 sm:px-6 lg:px-8">
        ...
        <div class="mt-10 grid grid-cols-1 gap-10 sm:grid-cols-2 lg:grid-cols-4">
          <div>
            <h3 class="text-lg font-medium text-warm-gray-900">Nairobi</h3>
          ...
          <div>
            <h3 class="text-lg font-medium text-warm-gray-900">Mombasa</h3>
            <p class="mt-2 text-base text-warm-gray-500">
              <span class="block">886 Walter Streets</span>

              <span class="block">Mombasa</span>
            </p>
          </div>

          <div>
            <h3 class="text-lg font-medium text-warm-gray-900">Kisumu</h3>
            <p class="mt-2 text-base text-warm-gray-500">
              <span class="block">7363 Cynthia Pass</span>

              <span class="block">Kisumu</span>
            </p>
          </div>

          <div>
            <h3 class="text-lg font-medium text-warm-gray-900">Nakuru</h3>
            <p class="mt-2 text-base text-warm-gray-500">
              <span class="block">114 Cobble Lane</span>

              <span class="block">Nakuru</span>
            </p>
          </div>
        </div>
      </div>
        ...
        <div class="space-y-8 xl:col-span-1">
          ...
          <p class="text-warm-gray-400 text-base">
            With operations across the Region, East African Gasoil Ltd (EAGOL)
             ...
             Our 10 years of operations have seen us continually meet and exceed 
             our customer’s needs by providing quality petroleum products .
          </p>
